...
ClapTrap constructor called and named: CL4P-TP
ClapTrap constructor called and named: SC4V-TP
ScavTrap SC4V-TP is created!
ClapTrap constructor called and named: FR4G-TP
FragTrap FR4G-TP is created!
ClapTrap CL4P-TP attacks CL4P-TP22, causing 0 points of damage!
ScavTrap SC4V-TP attacks SC4V-TP44, causing 20 points of damage!
FragTrap FR4G-TP attacks FR4G-TP66, causing 30 points of damage!
ScavTrap SC4V-TP is now in Gatekeeper mode!
FragTrap FR4G-TP wants a high-fives!
FragTrap FR4G-TP is destroyed!
Claptrap FR4G-TP destructor called
ScavTrap SC4V-TP is destroyed!
...
if (diff -q .expected.txt .output.txt >> /dev/null 2>&1); then
    ...
    echo -e "\033[1;33mOutput FragTrap:\033[0m" >> debug.txt
...
valgrind --leak-check=full ./FragTrap > .valgrind.txt 2>&1

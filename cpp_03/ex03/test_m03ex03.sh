...
ClapTrap constructor called and named: DI4M-TP_clap
ScavTrap DI4M-TP_clap is created!
FragTrap DI4M-TP_clap is created!
DiamondTrap DI4M-TP is created!
ScavTrap DI4M-TP_clap attacks DI4M-TP88, causing 30 points of damage!
FragTrap DI4M-TP_clap do a high fives!
ScavTrap DI4M-TP_clap is now in Gatekeeper mode!
DiamondTrap name: DI4M-TP, ClapTrap name: DI4M-TP_clap
DiamondTrap DI4M-TP is destroyed!
FragTrap DI4M-TP_clap is destroyed!
ScavTrap DI4M-TP_clap is destroyed!
Claptrap DI4M-TP_clap destructor called
EOF
if (diff -q .expected.txt .output.txt >> /dev/null 2>&1); then
    echo -e "\033[1;32mValide\033[0m"
    echo -e "\033[1;32mValide\033[0m" >> debug.txt
else
    echo -e "\033[1;33mOutput DiamondTrap:\033[0m" >> debug.txt
...
valgrind --leak-check=full ./DiamondTrap > .valgrind.txt 2>&1

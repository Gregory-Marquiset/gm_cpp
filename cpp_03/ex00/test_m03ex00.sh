...
ClapTrap CL4P-TP take 5 points of damage!
ClapTrap CL4P-TP self repaire 5 to his HP!
ClapTrap CL4P-TP self repaire 5 to his HP!
ClapTrap CL4P-TP self repaire 5 to his HP!
ClapTrap CL4P-TP self repaire 5 to his HP!
ClapTrap CL4P-TP self repaire 5 to his HP!
...
if (diff -q .expected.txt .output.txt >> /dev/null 2>&1); then
    ...
    echo -e "\033[1;33mOutput ClapTrap:\033[0m" >> debug.txt
...
valgrind --leak-check=full ./ClapTrap > .valgrind.txt 2>&1
